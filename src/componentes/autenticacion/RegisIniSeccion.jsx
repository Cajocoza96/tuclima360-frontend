...
export default function RegisIniSeccion({ titulo, lema, iconoUsuario, continuarComoInvitado,
    ...
    return (
        <div className="bg-amber-50 dark:bg-black w-full xss:min-h-[100svh] h-screen 
            ...
            <div className="w-full xss:min-h-[100svh] h-screen flex flex-col justify-between gap-1">
